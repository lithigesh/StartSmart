...
const BusinessAimForm = ({
  ...
  const sampleData = {
    businessModel:
      "SaaS (Software as a Service) with tiered subscription plans targeting agricultural businesses and individual farmers. Revenue generated through monthly/annual subscriptions, premium features, and consulting services.",
    revenueStreams: ["Subscription", "Consulting/Services", "Licensing"],
    targetMarket:
      "Primary: Small to medium agricultural businesses and tech-forward farmers in North America and Europe. Secondary: Agricultural cooperatives, urban farming initiatives, and agricultural technology integrators seeking AI-powered solutions.",
    marketSize:
      "$12.8B vertical farming market growing at 24% CAGR, with $4.2B in AI agricultural applications. Target addressable market of 2.4M farms in North America and 10.8M in Europe, representing $850M immediate opportunity.",
    competitionAnalysis:
      "Main competitors include AeroFarms, Plenty, and Iron Ox in hardware-focused solutions. Our competitive advantage lies in AI-powered optimization software that works with existing infrastructure, 60% lower cost than hardware-heavy alternatives, and faster deployment times.",
    pricingStrategy:
      "Freemium model: Basic plan free (up to 5 plants), Professional $29/month (unlimited plants + basic AI), Enterprise $99/month (advanced AI + analytics + support). Custom enterprise pricing for large operations. Annual plans offer 20% discount.",
    salesStrategy:
      "Digital-first approach with content marketing, SEO, and social media. Partner with agricultural suppliers and equipment manufacturers. Attend agricultural trade shows and conferences. Referral program for existing customers. Direct sales team for enterprise accounts.",
    marketingStrategy:
      "Inbound marketing through educational content about urban farming and AI technology. Partnerships with gardening influencers and sustainability advocates. Free webinars and workshops. Social proof through customer success stories and case studies.",
    fundingRequirement: "750000",
    useOfFunds:
      "Product Development (40% - $300K): AI algorithm refinement, mobile app enhancement, IoT integration. Marketing & Sales (30% - $225K): Digital marketing campaigns, trade show participation, sales team expansion. Operations (20% - $150K): Infrastructure scaling, customer support, quality assurance. Legal & Compliance (10% - $75K): Patent applications, regulatory compliance, legal documentation.",
    financialProjections:
      "Year 1: $120K revenue, 400 customers. Year 2: $480K revenue, 1,600 customers. Year 3: $1.2M revenue, 3,500 customers. Break-even expected month 18. Projected 15% monthly growth rate after initial traction period.",
    keyMetrics: [
    ...
    riskAssessment:
      "Technology risks: AI model accuracy, hardware compatibility issues. Market risks: Slow adoption of new technology, economic downturn affecting discretionary spending. Competition risks: Large tech companies entering market. Regulatory risks: Changing agricultural regulations.",
    mitigationStrategies:
      "Diversified technology stack to reduce single-point failures. Strong customer support and education programs. Strategic partnerships with established agricultural companies. Flexible pricing to accommodate market conditions. Continuous innovation to maintain competitive edge.",
    exitStrategy:
      "Strategic acquisition by major agricultural technology company (John Deere, Monsanto/Bayer) or agricultural equipment manufacturer within 5-7 years. Alternative: IPO after reaching $50M+ annual revenue. Focus on building valuable IP portfolio and customer base.",
    timeline:
      "24 months to full market presence: Months 1-6: Product refinement and beta testing. Months 7-12: Limited market launch and customer feedback integration. Months 13-18: Full product launch and scaling. Months 19-24: Market expansion and partnership development.",
    milestones: [
      {
        title: "Beta Product Launch",
        description:
          "Complete beta version with 50 test users providing feedback",
        targetDate: new Date(Date.now() + 6 * 30 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0], // 6 months from now
        keyDeliverables:
          "Functional AI algorithms, mobile app, user feedback analysis",
      },
      {
        ...
        keyDeliverables:
          "Payment system, customer support, marketing campaign launch",
      },
      {
        title: "Scale to 1000 Customers",
        description:
          "Reach 1000 paying customers across all subscription tiers",
        targetDate: new Date(Date.now() + 18 * 30 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0], // 18 months from now
        keyDeliverables:
          "Customer acquisition systems, retention programs, product optimization",
      },
    ],
  };
  ...
  const [formData, setFormData] = useState({
    ...
    competitionAnalysis:
      initialData.competitionAnalysis || sampleData.competitionAnalysis,
    ...
    marketingStrategy:
      initialData.marketingStrategy || sampleData.marketingStrategy,
    fundingRequirement:
      initialData.fundingRequirement || sampleData.fundingRequirement,
    useOfFunds: initialData.useOfFunds || sampleData.useOfFunds,
    financialProjections:
      initialData.financialProjections || sampleData.financialProjections,
    ...
    mitigationStrategies:
      initialData.mitigationStrategies || sampleData.mitigationStrategies,
  ...
  const validateForm = () => {
    ...
    if (!formData.businessModel.trim()) {
      ...
      newErrors.businessModel =
        "Business model description must be at least 20 characters long";
    }
    ...
    if (!formData.targetMarket.trim()) {
      ...
      newErrors.targetMarket =
        "Target market description must be at least 20 characters long";
    }
    ...
    if (!formData.competitionAnalysis.trim()) {
      ...
      newErrors.competitionAnalysis =
        "Competition analysis must be at least 50 characters long";
    }
    ...
    if (
      ...
      isNaN(formData.fundingRequirement.replace(/[,$]/g, ""))
    ) {
      newErrors.fundingRequirement =
    ...
    if (!formData.riskAssessment.trim()) {
      ...
      newErrors.riskAssessment =
        "Risk assessment must be at least 30 characters long";
    }
    ...
    formData.milestones.forEach((milestone, index) => {
      ...
      if (!milestone.timeline.trim()) {
        newErrors[`milestone_${index}_timeline`] =
          "Milestone timeline is required";
      }
    });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode && initialData._id) {
        ...
        result = await businessAimAPI.updateBusinessAim(
          initialData._id,
          submitData
        );
      } else {
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-3xl font-bold text-white font-manrope mb-3">
                {isEditMode
                  ? "Edit Business Aim & Strategy"
                  : "Business Aim & Strategy"}
              </h2>
              <p className="text-white/70 font-manrope text-lg">
                Define your business model, market strategy, and financial
                objectives for sustainable growth.
              </p>
              {!isEditMode && (
                <div className="mt-4 p-4 bg-black/95/10 border border-white/20 rounded-xl">
            ...
            <div className="bg-black/95 p-4 rounded-lg">
              ...
              <div>
                <label className="block text-sm font-medium text-white font-manrope mb-3">
                  Revenue Streams <span className="text-white/70">*</span>
                </label>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className={`w-full px-3 py-2 border bg-black/95 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white ${
                      errors.targetMarket ? "border-white" : "border-gray-600"
                    }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className={`w-full px-3 py-2 border bg-black/95 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white ${
                      errors.riskAssessment ? "border-white" : "border-gray-600"
                    }`}
            ...
            <div className="bg-black/95 p-4 rounded-lg">
              ...
              {formData.milestones.length === 0 ? (
                <div className="text-center py-4 text-gray-400">
                  ...
                  <p className="text-sm">
                    Click "Add Milestone" to define key achievements.
                  </p>
                </div>
              ) : (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateMilestone(index, "metrics", e.target.value)
                            }
                            className="w-full px-4 py-3 bg-white/[0.03] border border-white/10 rounded-lg text-white font-manrope backdrop-blur-sm transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/30"
