  ...
  const fetchRegistrations = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setRegistrations(
          allRegs.filter((r) => r.ideathon && r.ideathon._id === id)
        );
      }
    } catch (err) {
      ...
      <div className="bg-gradient-to-br from-white/[0.08] via-white/[0.02] to-white/[0.06] backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-xl">
        <div className="flex justify-between items-start mb-6">
          ...
          <button
            ...
            className="px-6 py-3 bg-white/20 text-white rounded-lg font-medium hover:bg-white/30 transition-all duration-300 flex items-center gap-3 backdrop-blur-sm border border-white/30"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <p className="text-white text-lg font-medium">
              {ideathon.location || "Not specified"}
            </p>
          </div>
        ...
        {ideathon.description && (
          <div className="mb-6">
            <p className="text-white/50 text-xs font-semibold uppercase mb-2">
              Description
            </p>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {ideathon.submissionFormat.map((format, idx) => (
                <span
                  key={idx}
                  className="px-3 py-1 bg-white/10 text-white/80 border border-white/20 rounded-full text-sm"
                >
                  {format}
                </span>
              ))}
        ...
        {registrations.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-white/70 text-lg">
              No registrations yet for this ideathon
            </p>
          </div>
        ) : (
          <div className="space-y-4">
            {registrations.map((registration) => (
              <div
                ...
                className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/8 transition-all duration-300"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-white/60 text-sm mb-1">
                      Team Lead: {registration.registeredBy?.name}
                    </p>
                    <p className="text-white/60 text-sm">
                      Contact:{" "}
                      {registration.registeredBy?.email ||
                        registration.entrepreneur?.email}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="enhanced-button p-2 bg-white/20 text-white/80 border border-white/30 rounded-lg hover:bg-white/30 transition-all duration-300"
                    >
                      <FaTrash />
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <p className="text-white/50 text-xs font-semibold uppercase mb-1">
                      Project Title
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      {registration.techStack || "Not specified"}
                    </p>
                  </div>
                </div>
                ...
                {registration.githubRepo && (
                  <div className="mb-4">
                    ...
                    <a
                      ...
                      className="text-white/90 hover:text-white/90 text-sm underline"
                    >
                      {registration.githubRepo}
                    </a>
                  </div>
          ...
          <div className="bg-gradient-to-br from-white/[0.15] via-white/[0.08] to-white/[0.12] backdrop-blur-xl border border-white/20 rounded-2xl p-8 w-full max-w-3xl max-h-[95vh] overflow-y-auto shadow-2xl custom-scrollbar ml-0 md:ml-32">
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
                  ...
                  <button
                    ...
                    className="enhanced-button px-4 py-2 bg-white/10/80 text-white rounded-lg hover:bg-white/10/80 transition-all duration-300"
                  >
                    Add
                  </button>
                </div>
                    ...
                    {registrationFormData.teamMembers.map((member, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-white/80 hover:text-white/80 p-1"
                        >
                          <FaTimes />
                        </button>
                      </div>
              ...
              <div className="flex justify-end space-x-4 pt-4">
                ...
                <button
                  type="submit"
                  className="enhanced-button px-6 py-2 bg-gradient-to-r from-white/500/80 to-white/600/80 text-white rounded-lg hover:from-white/400/90 hover:to-white/500/90 transition-all duration-300 backdrop-blur-sm border border-white/30"
                >
                  {editingRegistration
                    ? "Update Registration"
                    : "Register Team"}
