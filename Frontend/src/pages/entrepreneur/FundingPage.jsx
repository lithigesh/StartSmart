...
const FundingPage = () => {
  ...
  const handleFundingFormSubmit = async (e) => {
    ...
    if (!fundingFormData.ideaId || !fundingFormData.amount) {
      addNotification("Please fill in all required fields (Idea and Amount)", "error");
      return;
    }
    ...
    try {
      ...
      const result = await fundingAPI.createFundingRequest(fundingFormData);
