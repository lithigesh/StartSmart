          ...
          <div className="bg-white/[0.05] backdrop-blur-xl border border-white/10 rounded-2xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-manrope font-semibold text-white">
                  Investor Details
                </h2>
                <button
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-white/70">
                    Interested in: {selectedInvestor.ideaTitle}
                  </p>
                </div>
                ...
                {selectedInvestor.message && (
                  <div>
                    ...
                    <p className="text-white/80 bg-white/[0.05] rounded-lg p-4 border border-white/10">
                      {selectedInvestor.message}
                    </p>
                  </div>
                )}
                ...
                {selectedInvestor.investmentRange && (
                  <div>
                    ...
                    <p className="text-green-400 font-semibold">
                      {formatCurrency(selectedInvestor.investmentRange.min)} -{" "}
                      {formatCurrency(selectedInvestor.investmentRange.max)}
                    </p>
                  </div>
                )}
