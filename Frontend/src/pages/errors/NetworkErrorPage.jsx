      ...
      <div className="w-full max-w-2xl mx-auto px-4 z-10">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl shadow-black/20 relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            ...
            {/* Connection Steps */}
            <div className="mb-8 text-left bg-white/[0.02] border border-white/10 rounded-lg p-6">
              <h3 className="font-manrope font-semibold text-white mb-4">Troubleshooting steps:</h3>
              <ul className="space-y-2 text-white/70 text-sm font-manrope">
