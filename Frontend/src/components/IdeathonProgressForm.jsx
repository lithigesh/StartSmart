...
const IdeathonProgressForm = ({ registration, onClose, onSuccess }) => {
    ...
    const [progressData, setProgressData] = useState({
        ...
        currentStatus: registration.progressStatus || 'In Progress',
        completedTasks: '',
        pendingTasks: '',
        nextMilestones: '',
        blockingIssues: '',
    ...
    const handleFinalSubmission = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                toast.success('Final project submitted successfully! Your submission has been recorded.', {
                    duration: 5000,
                    position: 'top-center',
                });
            ...
            toast.error(error.response?.data?.message || 'Failed to submit final project. Please try again.', {
                duration: 4000,
                position: 'top-center',
            });
        } finally {
