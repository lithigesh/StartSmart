      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-white flex items-center gap-2 font-manrope">
            <FaDollarSign className="w-5 h-5 text-white/90" />
            Funding Analytics
          </h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white/[0.02] border border-white/10 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <FaCalendarAlt className="w-4 h-4 text-white/90" />
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <FaDollarSign className="w-4 h-4 text-white/90" />
              <span className="text-2xl font-bold text-white font-manrope">
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <FaArrowUp className="w-4 h-4 text-white/90" />
              <span className="text-2xl font-bold text-white font-manrope">
                {successRate}%
              </span>
            </div>
