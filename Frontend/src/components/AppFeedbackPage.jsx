...
const AppFeedbackPage = () => {
    ...
    const addFeature = () => {
        if (newFeature.trim() && !formData.mostUsedFeatures.includes(newFeature.trim())) {
            setFormData(prev => ({
                ...prev,
    ...
    const addImprovement = () => {
        if (newImprovement.trim() && !formData.suggestedImprovements.includes(newImprovement.trim())) {
            setFormData(prev => ({
                ...prev,
    ...
    const removeImprovement = (improvement) => {
        setFormData(prev => ({
            ...prev,
            suggestedImprovements: prev.suggestedImprovements.filter(i => i !== improvement)
        }));
    };
                    ...
                    <Star
                        ...
                        className={`${
                            star <= rating
                                ...
                                : 'text-gray-300'
                        } ${!readonly && setRating ? 'cursor-pointer hover:text-yellow-300' : ''}`}
    ...
    const getCategoryIcon = (category) => {
        ...
        return <IconComponent size={16} className={categoryData?.color || 'text-gray-500'} />;
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-6xl mx-auto px-4">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">App Feedback</h1>
                    <p className="text-gray-600">Help us improve StartSmart by sharing your feedback and suggestions</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">
                                        {stats.averageRecommendation ? stats.averageRecommendation.toFixed(1) : '0.0'}/10
                                    </p>
                                </div>
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <button
                                ...
                                className="w-full h-full flex flex-col items-center justify-center text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors"
                            >
                    ...
                    <div className="p-6">
                        {loading ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-600 mb-4">Start by sharing your thoughts about the app</p>
                                <button
                                    onClick={() => setShowForm(true)}
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center space-x-4 text-sm text-gray-500">
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        <ThumbsUp size={14} />
                                                        <span>Recommend: {item.recommendationScore}/10</span>
                                                    </div>
                                                </div>
                                                ...
                                                {item.adminResponse && item.adminResponse.response && (
                                                    <div className="mt-3 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                                                        ...
                                                        <p className="text-sm text-blue-800 mt-1">{item.adminResponse.response}</p>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                            <h2 className="text-xl font-semibold text-gray-900">Submit App Feedback</h2>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between text-sm text-gray-500">
                                        ...
                                        <span className="font-medium">{formData.recommendationScore}/10</span>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setFormData(prev => ({ ...prev, frequencyOfUse: e.target.value }))}
                            ...
                            {formData.category === 'bug_report' && (
                                <div className="space-y-4 p-4 bg-red-50 rounded-lg border">
                                    <h3 className="text-lg font-medium text-red-900">Bug Report Details</h3>
                            ...
                            {formData.category === 'feature_request' && (
                                <div className="space-y-4 p-4 bg-yellow-50 rounded-lg border">
                                    <h3 className="text-lg font-medium text-yellow-900">Feature Request Details</h3>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setFormData(prev => ({ ...prev, featurePriority: e.target.value }))}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        >
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="contactForFollowUp" className="ml-2 text-sm text-gray-700">
