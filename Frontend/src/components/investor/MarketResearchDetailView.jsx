      ...
      <div className="absolute inset-4 md:inset-8 lg:inset-12 xl:inset-16 bg-gradient-to-br from-gray-900 via-black to-gray-900 border-2 border-white/20 rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-scale-up">
        ...
        <div className="relative z-10 flex items-center justify-between p-6 lg:p-8 border-b border-white/10 bg-gradient-to-r from-white/[0.05] to-transparent backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2 ml-4">
            <button
              onClick={onEdit}
              className="p-3 text-white/70 hover:text-white/70 bg-white/20 hover:bg-white/30 rounded-xl transition-all duration-300 hover:scale-110 border border-white/30"
              title="Edit"
            >
            ...
            <button
              ...
              className="p-3 text-white/80 hover:text-white/80 bg-white/20 hover:bg-white/30 rounded-xl transition-all duration-300 hover:scale-110 border border-white/30"
              title="Delete"
            >
        ...
        <div className="relative z-10 flex-1 overflow-y-auto p-6 lg:p-8 space-y-6 custom-scrollbar">
          ...
          {research.tags && research.tags.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {research.tags.map((tag, index) => (
                <div
                  key={index}
                  className="bg-white/20/20 px-3 py-1.5 rounded-lg border border-white/30 flex items-center gap-2"
                >
                  <FaTag className="w-3 h-3 text-white/90" />
                  <span className="text-white/90 text-sm font-manrope font-medium">
                    {tag}
                  </span>
                </div>
              ))}
          ...
          <Section
            title="Market Size"
            icon={<FaChartLine className="w-5 h-5 text-white/90" />}
          ...
          <Section
            ...
            bgColor="from-white/[0.08]"
          />

          {/* Competitors */}
          <Section
            title="Competitors & Landscape"
            icon={<FaChartLine className="w-5 h-5 text-white/60" />}
          ...
          <Section
            ...
            icon={<FaFileAlt className="w-5 h-5 text-white/70" />}
          ...
          {research.relatedIdeas && research.relatedIdeas.length > 0 && (
            <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02] border-2 border-white/20 rounded-2xl p-6 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-white mb-4 font-manrope flex items-center gap-2">
                <FaLightbulb className="w-5 h-5 text-white/90" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {research.relatedIdeas.map((idea) => (
                  <div
                    key={idea._id}
                    className="bg-white/[0.05] border border-white/30 rounded-xl p-4 hover:bg-white/[0.08] hover:border-white/50 transition-all duration-300"
                  >
        ...
        <div className="relative z-10 flex items-center justify-between p-6 border-t border-white/10 bg-gradient-to-r from-white/[0.03] to-transparent backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onEdit}
              className="px-6 py-2 bg-white/20 text-white rounded-xl hover:bg-white/30 transition-all duration-300 font-manrope font-semibold flex items-center gap-2 hover:scale-105 hover:shadow-xl hover:shadow-white/30 border border-white/30"
            >
