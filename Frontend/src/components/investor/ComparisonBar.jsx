      ...
      <div className="lg:hidden">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {canCompare && (
              <span className="text-xs bg-white/10/20 text-white/90 px-2 py-1 rounded-full font-manrope font-medium">
                Ready
              </span>
            )}
            {isExpanded ? (
            ...
            <div className="flex-1 w-full lg:w-auto">
              ...
              <div className="flex flex-wrap gap-2 max-h-36 overflow-y-auto custom-scrollbar pr-2">
                {selectedIdeas.map((idea, index) => (
                  <div
                    key={idea._id}
                    className="bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-xl px-4 py-2.5 flex items-center gap-3 group hover:from-white/15 hover:to-white/10 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/10 animate-fade-in"
            ...
            <div className="flex items-center gap-3 w-full lg:w-auto">
              ...
              <button
                ...
                className={`
                  ...
                  ${
                    canCompare
                      ? "bg-gradient-to-r from-white via-white to-white bg-size-200 bg-pos-0 hover:bg-pos-100 text-white hover:scale-105 shadow-xl shadow-white/30 hover:shadow-2xl hover:shadow-white/40 border-2 border-white/50"
              ...
              >
                ...
                {canCompare && (
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 blur-xl group-hover:opacity-100 opacity-0 transition-opacity duration-300"></div>
                )}
              </button>
            </div>
          </div>
